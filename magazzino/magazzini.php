...
if (($_POST['action'] ?? '') === 'delete') {
  ...
  if ($id > 0) {
    ...
    mag_redirect('magazzini.php?msg=' . urlencode('Prodotto eliminato'));
  }
  mag_redirect('magazzini.php?msg=' . urlencode('ID non valido'));
}
...
<div class="card toolbar-card mb-3 border-0 shadow-sm">
  <div class="card-body">
    <form id="filterForm" class="row g-3 align-items-end" method="get" action="magazzini.php">
...
<div class="card border-0 shadow-sm of-table-card p-2">
...
(() => {
  ...
  async function refresh() {
    ...
    try {
      ...
      const newUrl = 'magazzini.php?' + qs.toString();
